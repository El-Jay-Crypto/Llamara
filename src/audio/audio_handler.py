...
def record_audio(file_path, timeout, phrase_time_limit, retries=3, energy_threshold=2000,
                 pause_threshold=0.8, phrase_threshold=0.1, dynamic_energy_threshold=True,
...
def convert_to_mp3(input_file, output_file):
    ...
    try:
        ...
        print(f"Error while converting audio: {e}")
        return None